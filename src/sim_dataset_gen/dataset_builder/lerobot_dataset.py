...
from huggingface_hub.constants import REPOCARD_NAME, HF_HOME
...
class LeRobotDatasetMetadata:
    ...
    def create(
        ...
        for feature, fdict in features.items():
            if fdict["dtype"] != "video":
                continue
            camera = feature.split(".")[-1].split("_")[0]
            modality["video"][camera] = {"original_key": feature}

        write_modality(modality, obj.root)
        obj.revision = None
        return obj
